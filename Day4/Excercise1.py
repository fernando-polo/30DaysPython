...
new_company = new_company.replace("Python", "Coding")
print(new_company.find("C"))


# Use index to determine the position of the first occurrence of F in Coding For All.
print(new_company.find("F"))
...
print(new_company.startswith('Coding'))


# Does 'Coding For All' end with a substring coding?
print(new_company.endswith('Coding'))

# '   Coding For All      '  , remove the left and right trailing spaces in the given string.
sentence2 = '   Coding For All      '
sentence2 = sentence2[3:18]
print(sentence2)
